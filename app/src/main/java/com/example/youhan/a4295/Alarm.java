...
public class Alarm implements Comparable<Alarm>
{
  ...
  {
    intent.putExtra("com.example.youhan.a4295.id", mId);
    intent.putExtra("com.example.youhan.a4295.title", mTitle);
    intent.putExtra("com.example.youhan.a4295.date", mDate);
    intent.putExtra("com.example.youhan.a4295.alarm", mEnabled);
    intent.putExtra("com.example.youhan.a4295.occurence", mOccurence);
    intent.putExtra("com.example.youhan.a4295.days", mDays);
  }

  public void fromIntent(Intent intent)
  {
    mId = intent.getLongExtra("com.example.youhan.a4295.id", 0);
    mTitle = intent.getStringExtra("com.example.youhan.a4295.title");
    mDate = intent.getLongExtra("com.example.youhan.a4295", 0);
    mEnabled = intent.getBooleanExtra("com.example.youhan.a4295.alarm", true);
    mOccurence = intent.getIntExtra("com.example.youhan.a4295.occurence", 0);
    mDays = intent.getIntExtra("com.example.youhan.a4295.days", 0);
    update();
  }
